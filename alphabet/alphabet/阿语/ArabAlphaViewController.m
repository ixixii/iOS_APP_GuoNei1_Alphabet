...
@interface ArabAlphaViewController ()
{
...
@implementation ArabAlphaViewController
...
{
    NSString *mp3Name = [NSString stringWithFormat:@"arab_%02d.mp3",_currentIndex+1];
    NSString *fullPath = [kMainBundle pathForResource:mp3Name ofType:nil];
